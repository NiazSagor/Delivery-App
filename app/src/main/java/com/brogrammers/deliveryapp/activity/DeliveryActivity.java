...
import com.paikariwala.user.bottomsheet.DeliverySummaryBottomSheet;
import com.paikariwala.user.bottomsheet.LocationSelectionBottomSheet;
import com.paikariwala.user.bottomsheet.ReceiverDetailsBottomSheet;
import com.paikariwala.user.callbacks.OnDeliverySummaryBottomSheetInteraction;
import com.paikariwala.user.callbacks.OnLocationBottomSheetInteraction;
import com.paikariwala.user.callbacks.OnParcelOrderPlacedCallback;
import com.paikariwala.user.callbacks.OnReceiverDetailBottomSheetInteraction;
import com.paikariwala.user.model.ParcelDeliveryOrder;
import com.paikariwala.user.model.Receiver;
import com.paikariwala.user.viewmodels.DeliveryActivityViewModel;
